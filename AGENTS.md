...
- Clarification is vital: if any requirement, intended visual result, rule interpretation, or implementation consequence is uncertain, ask the user before making the change. Do not guess when that guess could materially affect the result.
